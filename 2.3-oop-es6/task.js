...
// sword.takeDamage(5);
// console.log(`Прочность Старого меча урон 5: ${sword.durability}`); // 5

// sword.takeDamage(50);
// console.log(`Прочность Старого меча урон 50: ${sword.durability}`); // 0

// arm.takeDamage(20);
// console.log(`Прочность руки урон 20: ${arm.durability}`); // Infinity

// bow.takeDamage(20);
// console.log(`Прочность лука урон 20: ${bow.durability}`); // 180

// bow.takeDamage(200);
// console.log(`Прочность лука урон 200: ${bow.durability}`); // 0

// console.log(`Прочность лука: ${bow.durability}`); // 0
// console.log(`Нанесено урона: ${bow.getDamage()}`); // 0

// console.log(`Прочность руки: ${arm.durability}`); // Infinity
// console.log(`Нанесено урона: ${arm.getDamage()}`); // 1

// console.log(`Прочность лука: ${bow.durability}`); // 0
// console.log(`Сломан ли лук ? ${bow.isBroken()}`); // true

// console.log(`Прочность руки: ${arm.durability}`); // Infinity
// console.log(`Сломана ли рука ? ${arm.isBroken()}`); // false
...
class StudentLog {
    ...
    getAverageBySubject(subject){
        ...
        if(!this.gradesOfSubjects.hasOwnProperty(subject)){
            ...
            wholeGrade += this.gradesOfSubjects[subject][i] / this.gradesOfSubjects[subject].length;
            }
            return wholeGrade 
        }
    }
